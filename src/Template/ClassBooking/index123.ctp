...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<?php				
			...
			echo '<div class="col-md-6">';
			echo $this->Form->input("",["label"=>false,"name"=>"booking_date","class"=>"form-control dob validate[required] datepick","value"=>(($edit)?date($this->Gym->getSettings("date_format"),strtotime($data['booking_date'])):''),"onkeydown"=>"return false"]);
			echo "</div>";
			echo "</div>";
			echo "</fieldset>";
...
$(document).ready(function(){
	...
	//$(".dob").datepicker({yearRange: "+0:+0",changeYear: true,changeMonth: true, dateFormat:"<?php echo $this->Gym->dateformat_PHP_to_jQueryUI($this->Gym->getSettings("date_format")); ?>" ,"language" : "<?php echo $dtp_lang;?>"});
