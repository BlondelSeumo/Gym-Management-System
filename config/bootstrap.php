...
if (!extension_loaded('intl')) {
	...
	echo '<div margin-top:90px">';
	echo "<h1 style='padding:200px 200px 200px 200px;text-transform: capitalize;'>In your server , You must enable the intl extension to use This cakephp package..</h1>";
	echo '</div>';
